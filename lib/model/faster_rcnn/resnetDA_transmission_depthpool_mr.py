...
class resnetDA_transmission_depthpool_mr(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes):
    ...
    pooled_dep = pooled_dep.mean(1).view(300,-1)
    pooled_feat1 = pooled_feat1.mean(1).view(300,-1)
    pooled_feat2 = pooled_feat2.mean(1).view(300,-1)
    pooled_feat3 = pooled_feat3.mean(1).view(300,-1)
