...
class resnetDA_transmission_depthpool(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    self.RCNN_cls_score = nn.Linear(2048+49, self.n_classes)
    if self.class_agnostic:
      self.RCNN_bbox_pred = nn.Linear(2048+49, 4)
    else:
      self.RCNN_bbox_pred = nn.Linear(2048+49, 4 * self.n_classes)
