...
class vgg16_res2_add_2DA_r_ms_rfrb(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes):
    ...
    restored_feat = self.RFRB2(base_feat_rgb)
    base_feat_rgb = self.RCNN_base2(base_feat_rgb)
    base_feat_rgb = torch.add(base_feat_rgb, restored_feat)
    ...
    restored_feat_red = self.RFRB2(base_feat_red)
    base_feat_red = self.RCNN_base2(base_feat_red)
    base_feat_red = torch.add(base_feat_red, restored_feat_red)

    base_feat_green = self.RCNN_base1(green)
    restored_feat_green = self.RFRB2(base_feat_green)
    base_feat_green = self.RCNN_base2(base_feat_green)
    base_feat_green = torch.add(base_feat_green, restored_feat_green)

    base_feat_blue = self.RCNN_base1(blue)
    restored_feat_blue = self.RFRB2(base_feat_blue)
    base_feat_blue = self.RCNN_base2(base_feat_blue)
    base_feat_blue = torch.add(base_feat_blue, restored_feat_blue)
    ...
    '''----------stage 2------------------------'''
    base_feat_rgb = self.RCNN_base2(base_feat_rgb)
    res_feat = self.RCNN_base2(res_feat)
