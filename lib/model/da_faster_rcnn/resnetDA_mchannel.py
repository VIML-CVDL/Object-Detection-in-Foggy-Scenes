...
class resnetDA_mchannel(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    base_feat_2 = self.se1(base_feat_2)
    base_feat_2 = base_feat_2 + residual_1
    base_feat_2 = self.relu(base_feat_2)
    residual_2 = self.downsample2(base_feat_2)

    '''----------stage 3------------------------'''
    base_feat = self.RCNN_base3(base_feat_2)
    base_feat = self.se2(base_feat)
    base_feat = base_feat + residual_2
    ...
    tgt_base_feat_2 = self.se1(tgt_base_feat_2)
    tgt_base_feat_2 = tgt_base_feat_2 + tgt_residual_1
    ...
    tgt_base_feat = self.se2(tgt_base_feat)
    tgt_base_feat = tgt_base_feat + tgt_residual_2
