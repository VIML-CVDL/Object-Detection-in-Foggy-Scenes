...
class SCL(nn.Module):
    def __init__(self, dim):
        ...
        self.conv1 = conv3x3(dim, dim, padding=1)
        self.conv2 = conv3x3(dim, 128, padding=1)
...
class resnetms3scl(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    self.scl2 = SCL(512)
    self.scl3 = SCL(1024)
    self.transfer1 = nn.Linear(45000, 2048)
    self.transfer2= nn.Linear(11250, 2048)
    self.transfer3 = nn.Linear(2850, 2048)
    self.fuse = nn.Linear(512, 128)
    self.fuse.weight.data.normal_(0, 0.01)
    ...
    self.RCNN_imageDA_2 = _ImageDA(512)
...
#    print('adasdasdadasdaasdasdasdasda')
    ...
    '''----------stage 3------------------------'''
    base_feat = self.RCNN_base3(base_feat_2)
    ...
    scl_feat_1 = self.scl1(base_feat_1.detach())
    scl_feat_1 = self.transfer1(scl_feat_1.view(128, -1))
    scl_feat_2 = self.scl2(base_feat_2.detach())
    scl_feat_2 = self.transfer2(scl_feat_2.view(128, -1))
    scl_feat_3 = self.scl3(base_feat.detach())
    scl_feat_3 = self.transfer3(scl_feat_3.view(128, -1))
    scl_feat = torch.cat((scl_feat_1, scl_feat_2, scl_feat_3), 0)
    ...
    '''----------stage 3------------------------'''
    tgt_base_feat= self.RCNN_base3(tgt_base_feat_2)
    ...
    return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, rois_label,\
           ...
           DA_img_loss_cls_1,tgt_DA_img_loss_cls_1,DA_img_loss_cls_2,tgt_DA_img_loss_cls_2
