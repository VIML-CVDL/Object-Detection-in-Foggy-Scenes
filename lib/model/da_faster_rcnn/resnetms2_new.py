...
class resnetms2_new(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    #print(cfg.RESNET.FIXED_BLOCKS) == 1
...
#    print('adasdasdadasdaasdasdasdasda')
    ...
    base_feat_1 = self.RCNN_base[:6](im_data)

    '''----------stage 2------------------------'''
    base_feat = self.RCNN_base[6](base_feat_1)
    ...
    '''------------stage 1-------------------'''
    # feed image data to base model to obtain base feature map
    tgt_base_feat_1 = self.RCNN_base[:6](tgt_im_data)

    '''----------stage 2------------------------'''
    tgt_base_feat= self.RCNN_base[6](tgt_base_feat_1)
