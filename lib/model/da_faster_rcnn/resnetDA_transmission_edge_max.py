...
class resnetDA_transmission_edge_max(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    edge_loss = 1 / ((img_hazy_edge_x.sum() + img_hazy_edge_y.sum()) / c)

    return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, rois_label, prior_loss, edge_loss*10
