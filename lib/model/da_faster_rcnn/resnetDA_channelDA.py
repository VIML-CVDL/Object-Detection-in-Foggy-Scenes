...
class resnetDA_channelDA(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    base_feat_DA = self.se(base_feat)
    ...
    tgt_base_feat_DA = self.se(tgt_base_feat)
    ...
    base_score, base_label = self.RCNN_imageDA(base_feat_DA, need_backprop)
    ...
    tgt_base_score, tgt_base_label = \
        self.RCNN_imageDA(tgt_base_feat_DA, tgt_need_backprop)
