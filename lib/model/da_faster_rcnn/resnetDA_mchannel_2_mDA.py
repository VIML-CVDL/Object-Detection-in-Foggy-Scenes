...
class resnetDA_mchannel_2_mDA(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    tgt_base_feat_2 = tgt_base_feat_2 + tgt_base_feat_2_se
    ...
    tgt_base_feat = tgt_base_feat + tgt_base_feat_se
