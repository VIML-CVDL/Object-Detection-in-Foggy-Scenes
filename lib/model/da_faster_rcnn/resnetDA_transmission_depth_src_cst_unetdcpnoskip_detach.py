...
class resnetDA_transmission_depth_src_cst_unetdcpnoskip_detach(_fasterRCNN):
...
#                                                up_conv_in_channels=128, up_conv_out_channels=64))
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    up_1 = self.up_blocks[0](tgt_base_feat)
    up_2 = self.up_blocks[1](up_1)
    up_3 = self.up_blocks[2](up_2, no_up=True)
    up_4 = self.up_blocks[3](up_3)
    ...
    recloss = nn.MSELoss()
    rec_loss = recloss(rec_feat, tgt_clean_new)
    #rec_loss = 0
