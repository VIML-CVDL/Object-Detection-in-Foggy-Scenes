...
class resnetms2_mcst_2(_fasterRCNN):
...
#    print('adasdasdadasdaasdasdasdasda')
    ...
    consistency_prob_1=consistency_prob_1.repeat(instance_sigmoid.size())
    ...
    DA_cst_loss_1=self.consistency_loss(instance_sigmoid,consistency_prob_1.detach())
    ...
    tgt_consistency_prob_1 = tgt_consistency_prob_1.repeat(tgt_instance_sigmoid.size())
    ...
    tgt_DA_cst_loss_1 = self.consistency_loss(tgt_instance_sigmoid, tgt_consistency_prob_1.detach())

    return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, rois_label,\
           DA_img_loss_cls,DA_ins_loss_cls,tgt_DA_img_loss_cls,tgt_DA_ins_loss_cls,DA_cst_loss,tgt_DA_cst_loss,\
           DA_img_loss_cls_1,tgt_DA_img_loss_cls_1,DA_cst_loss_1,tgt_DA_cst_loss_1
