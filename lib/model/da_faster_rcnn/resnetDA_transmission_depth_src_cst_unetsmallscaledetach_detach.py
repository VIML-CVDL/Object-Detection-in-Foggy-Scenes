...
class resnetDA_transmission_depth_src_cst_unetsmallscaledetach_detach(_fasterRCNN):
...
#                                                up_conv_in_channels=128, up_conv_out_channels=64))
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    up_1 = self.up_blocks[0](tgt_base_feat.detach(), tgt_base_feat_down_6.detach())
