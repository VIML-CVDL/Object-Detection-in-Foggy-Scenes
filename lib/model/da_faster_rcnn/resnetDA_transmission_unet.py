...
class resnetDA_transmission_unet(_fasterRCNN):
...
#                                                up_conv_in_channels=128, up_conv_out_channels=64))
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    up_1 = self.up_blocks[0](tgt_base_feat, tgt_base_feat_down_6)
    up_2 = self.up_blocks[1](up_1, tgt_base_feat_down_5)
    up_3 = self.up_blocks[2](up_2, tgt_base_feat_down_4, no_up=True)
    up_4 = self.up_blocks[3](up_3, tgt_base_feat_down_3)
    ...
    return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, rois_label, prior_loss, rec_loss/(60*120)
