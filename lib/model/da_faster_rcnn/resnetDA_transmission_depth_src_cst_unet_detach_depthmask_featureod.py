...
class resnetDA_transmission_depth_src_cst_unet_detach_depthmask_featureod(_fasterRCNN):
...
#                                                up_conv_in_channels=128, up_conv_out_channels=64))
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    base_feat = base_feat * dep[:,0,:,:].detach().repeat(1,1024,1,1)
    ...
    tgt_base_feat =  tgt_base_feat * tgt_dep[:,0,:,:].repeat(1,1024,1,1)
