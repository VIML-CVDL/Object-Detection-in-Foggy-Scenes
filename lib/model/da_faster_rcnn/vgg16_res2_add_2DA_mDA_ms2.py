...
class vgg16_res2_add_2DA_mDA_ms2(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    self.RCNN_base2 = nn.Sequential(*list(vgg.features._modules.values())[-15:-8])
    self.RCNN_base3 = nn.Sequential(*list(vgg.features._modules.values())[-8:-1])

    self.RCNN_imageDA = _ImageDA(self.dout_base_model)
    self.RCNN_imageDAres = _ImageDA(self.dout_base_model)
    self.RCNN_imageDA_1 = _ImageDA(256)
    self.RCNN_imageDAres_1 = _ImageDA(256)
    self.RCNN_imageDA_2 = _ImageDA(self.dout_base_model)
    self.RCNN_imageDAres_2 = _ImageDA(self.dout_base_model)
