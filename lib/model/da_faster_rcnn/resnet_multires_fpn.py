...
class resnet_multires_fpn(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    base_feat_1 = self.down(base_feat_1)
    base_feat_1 = base_feat_up + base_feat_1
    ...
    tgt_base_feat_1 = self.down(tgt_base_feat_1)
    tgt_base_feat_1 = tgt_base_feat_up + tgt_base_feat_1
    ...
    if cfg.POOLING_MODE == 'crop':
        ...
        tgt_pooled_feat_1 = self.RCNN_roi_align_1(tgt_base_feat_1, tgt_rois.view(-1, 5))
    elif cfg.POOLING_MODE == 'pool':
