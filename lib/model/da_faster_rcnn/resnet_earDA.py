...
class resnet_earDA(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    self.RCNN_imageDA = _ImageDA(512)
...
#    print('adasdasdadasdaasdasdasdasda')
    ...
    base_score, base_label = self.RCNN_imageDA(base_feat_1, need_backprop)
    ...
    tgt_base_score, tgt_base_label = \
        self.RCNN_imageDA(tgt_base_feat_1, tgt_need_backprop)
