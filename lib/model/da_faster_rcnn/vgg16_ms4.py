...
class vgg16_ms4(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    self.RCNN_base2 = nn.Sequential(*list(vgg.features._modules.values())[-27:-22])
    self.RCNN_base3 = nn.Sequential(*list(vgg.features._modules.values())[-22:-15])
    self.RCNN_base4 = nn.Sequential(*list(vgg.features._modules.values())[-15:-8])
    self.RCNN_base5 = nn.Sequential(*list(vgg.features._modules.values())[-8:-1])

    self.RCNN_imageDA = _ImageDA(self.dout_base_model)
    self.RCNN_imageDA_1 = _ImageDA(64)
    self.RCNN_imageDA_2 = _ImageDA(128)
    self.RCNN_imageDA_3 = _ImageDA(256)
    self.RCNN_imageDA_4 = _ImageDA(self.dout_base_model)
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    '''----------stage 4------------------------'''
    base_feat_4 = self.RCNN_base4(base_feat_3)

    '''----------stage 5------------------------'''
    base_feat = self.RCNN_base5(base_feat_4)
    ...
    '''----------stage 4------------------------'''
    tgt_base_feat_4= self.RCNN_base4(tgt_base_feat_3)

    '''----------stage 5------------------------'''
    tgt_base_feat= self.RCNN_base5(tgt_base_feat_4)
    ...
    base_score_4, base_label_4 = self.RCNN_imageDA_4(base_feat_4, need_backprop)
    ...
    # Image DA
    base_prob_4 = F.log_softmax(base_score_4, dim=1)
    DA_img_loss_cls_4 = F.nll_loss(base_prob_4, base_label_4)
    ...
    """  ************** taget loss ****************  """
    tgt_base_score_4, tgt_base_label_4 = \
        self.RCNN_imageDA_4(tgt_base_feat_4, tgt_need_backprop)
    ...
    # Image DA
    tgt_base_prob_4 = F.log_softmax(tgt_base_score_4, dim=1)
    tgt_DA_img_loss_cls_4 = F.nll_loss(tgt_base_prob_4, tgt_base_label_4)
    ...
    return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, rois_label,\
           ...
           DA_img_loss_cls_4,tgt_DA_img_loss_cls_4
