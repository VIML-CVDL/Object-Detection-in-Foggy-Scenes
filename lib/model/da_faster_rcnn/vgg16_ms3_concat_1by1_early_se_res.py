...
class vgg16_ms3_concat_1by1_early_se_res(_fasterRCNN):
  ...
  def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
    ...
    base_feat = torch.cat((base_feat_1, res_feat_1), 1)
    base_feat = self.se(base_feat) + base_feat_1
    ...
    tgt_base_feat_1 = torch.cat((tgt_base_feat_1, tgt_res_feat_1), 1)
    tgt_base_feat_1 = self.se(tgt_base_feat_1)
