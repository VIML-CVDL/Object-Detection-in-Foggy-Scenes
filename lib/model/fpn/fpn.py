...
class _FPN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic):
        ...
        self.RCNN_roi_align = RoIAlignAvg2(cfg.POOLING_SIZE, cfg.POOLING_SIZE, 1.0/16.0)
        self.grid_size = cfg.POOLING_SIZE * 2 if cfg.CROP_RESIZE_WITH_MAX_POOL else cfg.POOLING_SIZE
        self.RCNN_roi_crop = _RoICrop()

        self.RCNN_imageDA = _ImageDA(self.dout_base_model)
        self.RCNN_instanceDA = _InstanceDA(size=1024)
    ...
    def _PyramidRoI_Feat(self, feat_maps, rois, im_info, list=False):
        ...
        if list:
            return roi_pool_feat, feat_list, feat_idx_list
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
        ...
        base_score, base_label = self.RCNN_imageDA(p5, need_backprop)
        ...
        tgt_base_score, tgt_base_label = \
            self.RCNN_imageDA(tgt_p5, tgt_need_backprop)
