...
class rtts(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'rtts_' + year + '_' + image_set)
        self._year = year
        self._image_set = image_set

        self._devkit_path = self._get_default_path() if devkit_path is None \
            else devkit_path
        self._devkit_path = '/home/jeremy/workspace/datasets/RTTS_voc'
        #self._data_path = os.path.join(self._devkit_path, 'VOC' + self._year)
        self._data_path = '/home/jeremy/workspace/datasets/RTTS_voc/VOC2007'
