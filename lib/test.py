...
from model.faster_rcnn.resnetDA import resnetDA
from model.faster_rcnn.resnetDA_transmission import resnetDA_transmission
from model.faster_rcnn.resnetDA_transmissionDA import resnetDA_transmissionDA
...
if __name__ == '__main__':
  ...
  elif args.dataset == "foggydriving":
      print('loading our dataset...........')
      args.s_imdb_name = "cityscape_2007_train_s"
      args.t_imdb_name = "foggydriving_2007_test"
      args.s_imdbtest_name="cityscape_2007_test_s"
      args.t_imdbtest_name = "foggydriving_2007_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4,8,16,32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
  elif args.dataset == "rtts":
      print('loading our dataset...........')
      args.t_imdbtest_name = "rtts_2007_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4,8,16,32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
  elif args.dataset == "stf":
      print('loading our dataset...........')
      args.t_imdbtest_name = "stf_2007_fog_day_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4,8,16,32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
  elif args.dataset == "nus":
      print('loading our dataset...........')
      args.imdb_name = "nus_2007_valid"
      args.t_imdbtest_name = "nus_2007_valid"
  ...
  if args.net == 'vgg16':
    ...
    fasterRCNN = resnetDA(imdb.classes, 101, pretrained=False, class_agnostic=args.class_agnostic)
  elif args.net == 'res101_transmission':
    fasterRCNN = resnetDA_transmission(imdb.classes, 101, pretrained=False, class_agnostic=args.class_agnostic)
  elif args.net == 'res50':
  ...
  for i in range(num_images):
      ...
      #depth_loss += dloss(dep.cpu().detach(), dep2.squeeze(0).permute([0,3,1,2]))
      ...
      if vis:
          import cv2
          cv2.imwrite('./output/' + str(i) + '.png', im2show)
